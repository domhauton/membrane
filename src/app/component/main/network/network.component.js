...
var NetworkComponent = (function () {
    function NetworkComponent(membraneDaemonService) {
        var _this = this;
        this.membraneDaemonService = membraneDaemonService;
        this.title = 'Networked Storage';
        ...
        this.membraneDaemonService.getContractInfoStream().subscribe(function (data) { return _this.contractInfo = data; }, function (error) { return console.error(error); }, function () { return console.log("Retrieved Contract Info Successfully"); });
        this.membraneDaemonService.getNetworkStatusStream().subscribe(function (data) { return _this.networkStatus = data; }, function (error) { return console.error(error); }, function () { return console.log("Retrieved Network Status Successfully"); });
    }
