...
var WatcherComponent = (function () {
    function WatcherComponent(membraneDaemonService) {
        var _this = this;
        this.membraneDaemonService = membraneDaemonService;
        this.title = 'Watcher Status';
        ...
        this.membraneDaemonService.getWatcherStatusStream().subscribe(function (data) { return _this.watcherStatus = data; }, function (error) { return console.error(error); }, function () { return console.log("Retrieved Watcher Status Successfully"); });
    }
...
exports.WatcherComponent = WatcherComponent;
